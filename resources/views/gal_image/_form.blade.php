...
<div class="form-group">
    {!! Form::label('cat_gallery_id', 'Category Gallery:', ['class' => 'control-label']) !!}
     <small class="required">(Required)</small>
    @if(count($cat_gallery_id)>0)
    {!! Form::select('cat_gallery_id', $cat_gallery_id,Input::old('cat_gallery_id'),['class' => 'form-control','required']) !!}
    @else
    {!! Form::text('cat_gallery_id', 'No Category ID available',['id'=>'cat_gallery_id','class' => 'form-control','required','disabled']) !!}
    @endif
</div>
