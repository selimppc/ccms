                    ...
                    <table  class="display table table-bordered table-striped" id="data-table-example">
                        ...
                        @if(isset($data))
                            @foreach($data as $values)
                                <tr class="gradeX">
                                    <td>{{$values->relCatGallery->title}}</td>
                                    <td>{{$values->name}}</td>
                                    <td><div><a href="{{ route('gal_image.image.show', $values->slug) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#imageView"><img src="{{ URL::to($values->thumbnail) }}" alt="{{$values->image}}" /></a></div>
                                    </td>
                                    <td>{{$values->status}}</td>
                                    <td>
