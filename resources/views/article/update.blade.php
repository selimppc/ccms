                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <small class="required">(Required)</small>
                            {!! Form::select('type', \App\Article::AritcleMenu(),null, ['id'=>'position', 'class' => 'form-control','required']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group last">
                            ...
                            <div class="col-md-9">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail">
                                        @if($data['featured_image_2'] != '')
                                            <a href="{{ route('article.image.show', $data['slug']) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#imageView"><img src="{{ URL::to($data['thumbnail_2']) }}" alt="{{$data['thumbnail_2']}}" />
                                            </a>
                                        @else
                                            <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" />
                                        @endif
