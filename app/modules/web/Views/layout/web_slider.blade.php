<div id="slider" >
    ...
    <div class="ls-layer">
        ...
        <div id="layer-01-slide-03" class="ls-s2" style="layer1-sublayer4" data-rel="delayin: 100; slidedirection: right; slideoutdirection: left; durationin: 1000;">
            ...
            <a href="{{URL::to('free-trial')}}" class="slider-button">Try 2 Images for free now <span>></span></a>
        </div>
    </div>
    ...
    <div class="ls-layer">
        ...
        <div id="layer-02-slide-02" class="ls-s2" style="layer2-sublayer2" data-rel="delayin: 100; slidedirection: left; slideoutdirection: bottom; durationin: 1500;">
            ...
            <p class="style-02">working  <span class="highlight">24/7</span><br>
                "A trustworthy name for many Online Retailers and Photographers"</p>
            <a href="{{URL::to('free-trial')}}" class="slide02-button">Free Trial <span>></span></a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="span12">
                <ul class="slider-items-list">
                    ...
                    <li><a href="{{ 'shadow-and-reflection-creation' }}">Shadow & Reflection Creation</a></li>
                </ul>
                <div class="contact-area"> <span class="lan"> <a href="callto:bzmgraphics" class="lan"><i class="fa fa-skype"> </i> Skype</a> </span> &nbsp;&nbsp;&nbsp; <a href="mailto:hello@bzmgraphics.com" class="email"><i class="fa fa-envelope"> </i> hello@bzmgraphics.com </a>
