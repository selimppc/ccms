...
class GalImageController extends Controller
{
    ...
    public function index()
    {
        ...
        $cat_gallery_id = CatGallery::lists('title','id');

        return view('gal_image.index', ['data' => $data, 'pageTitle'=> $pageTitle, 'cat_gallery_id'=> $cat_gallery_id]);
    }
    ...
    public function store(Requests\GalImageRequest $request)
    {
        ...
        $cat_gallery_id = Input::get('cat_gallery_id');
        $tittle = Input::get('name');
        $slug = str_slug($tittle);

        $exists = GalImage::where('cat_gallery_id',$cat_gallery_id)->exists();
        if($exists){
            $count = GalImage::where('cat_gallery_id',$cat_gallery_id)->count();
    ...
    public function edit($slug)
    {
        $data = GalImage::where('slug',$slug)->first();
        $cat_gallery_id = CatGallery::lists('title','id');
        return view('gal_image.update', ['data' => $data,'cat_gallery_id'=>$cat_gallery_id]);
    }
